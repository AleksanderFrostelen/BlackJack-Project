...
public class Deck {
	...
	public Deck() {
		...
		name = new ArrayList<String>(
				Arrays.asList("2", "3", "4", "5", "6", "7", "8", "9", "10", "Knekt", "Dam", "Kung", "Ess"));
	...
	void deckSetup() {
		...
		for (int VALUESPANElem = 0; VALUESPANElem < deckSetup.length; VALUESPANElem = VALUESPANElem
				+ VALUESPAN.length) {
	...
	String showOneCard(Player playerObj, int handIndex, int cardIndex)// Returnerar valören på det första kortet på
																		// hand.
	{
